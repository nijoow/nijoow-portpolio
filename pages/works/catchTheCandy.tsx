      ...
      <section>
        ...
        <div className={styles.workInfomation}>
          ...
          <ul className={styles.infoContents}>
            ...
            <li>
              <span className={styles.bold}>[컨셉] Bias </span>
              <br />- 바구니를 선택하면 게임은 시작된다. 높은 점수를 얻기 위해
              이리저리 움직이며 떨어지는 사탕들을 받아보자. 게임에 온전히
              몰입하고 빠져들어보는 것이다. 다양한 사탕을 제대로 받고 있는 것이
              맞을까? 예상과는 다른 결과가 나올지도 모른다.
            </li>
            <li>
              <span className={styles.bold}>[실행 과정] </span>
              <br />
            ...
            <li>
              <span className={styles.bold}>[기술 스택]</span> <br />-
              Javascript (p5.js)
            </li>
            <li>
            ...
            <li>
              <span className={styles.bold}>[역할] </span>
              <br />
              - 아이디어 및 컨셉 기획
              <br />- 게임 기능 개발
            </li>
            <li>
              <span className={styles.bold}>[시연 영상] </span>
              <br />
