    ...
    <>
      <section>
        <div className="title">
          ...
          <span className="secondTitle">&nbsp;&nbsp;&gt;&nbsp;&nbsp;MEMORY</span>
        </div>
        <div className={styles.workInfomation}>
          ...
          <ul className={styles.infoContents}>
            <li className="bold">부산대학교 디자인학과 디자인엔테크놀로지 전공 12회 졸업전시회 웹사이트</li>
            <li>
          ...
          <a href="https://github.com/nijoow/PNUDT12" target="_blank" rel="noopener noreferrer">
