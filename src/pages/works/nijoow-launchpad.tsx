    ...
    <>
      ...
      <section>
        <div className="title">
          ...
          <span className="secondTitle">&nbsp;&nbsp;&gt;&nbsp;&nbsp;nijoow-launchpad</span>
        </div>
        <div className={styles.workInfomation}>
          ...
          <ul className={styles.infoContents}>
            <li>
              ...
              <br /> 전자 악기 런치패드의 형태로 피아노와 드럼을 연주할 수 있는 토이프로젝트 웹사이트
            </li>
            <li>
            ...
            <li>
              ...
              <br />- 마우스/키보드/터치 이벤트로 런치패드를 클릭할 때 마다 사운드 재생
            </li>
          </ul>{' '}
          <a href="https://github.com/nijoow/nijoow-launchpad" target="_blank" rel="noopener noreferrer">
