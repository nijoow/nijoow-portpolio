...
const Three = () => {
  return (
    <div className="relative mb-8 h-[200px] w-full overflow-hidden rounded-3xl bg-white sm:h-[320px] dark:bg-black">
      ...
      <div className="pointer-events-none absolute inset-0 z-10 rounded-3xl border border-black/10 shadow-[inset_0_10px_40px_rgba(0,0,0,0.15),inset_0_-2px_4px_rgba(255,255,255,0.5)] dark:border-white/10 dark:shadow-[inset_0_10px_40px_rgba(0,0,0,0.8),inset_0_-2px_4px_rgba(255,255,255,0.05)]" />
    </div>
  );
};
