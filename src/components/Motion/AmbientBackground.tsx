  ...
  return (
    <div className="pointer-events-none fixed inset-0 -z-20 overflow-hidden select-none">
      ...
      <motion.div
        ...
        className="absolute -left-[15%] top-[5%] h-[600px] w-[600px] rounded-full bg-purple-400/20 blur-[130px] dark:bg-purple-900/10"
      />
      <motion.div
        ...
        className="absolute -right-[10%] top-[30%] h-[700px] w-[700px] rounded-full bg-blue-400/15 blur-[150px] dark:bg-blue-900/5"
      />
      <motion.div
        ...
        className="absolute left-[10%] top-[65%] h-[550px] w-[550px] rounded-full bg-indigo-400/20 blur-[120px] dark:bg-indigo-900/8"
      />

      {/* Floating Glass Dust - 마운트 완료 후 입자 렌더링 */}
      {isMounted && dustParticles.map((particle) => (
        <motion.div
          key={particle.id}
          initial={{
            left: particle.left,
          ...
          className="absolute h-1.5 w-1.5 rounded-full bg-white/40 blur-[1px] dark:bg-white/10"
        />
      ))}
