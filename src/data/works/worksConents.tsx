...
export const WorkContent: WorkContents = {
  'nijoow-vintage': (
    <>
      ...
      <span className="text-base font-medium">- 빈티지 쇼핑몰 토이프로젝트</span>
      <div className="my-1" />
  ...
  'catch-the-candy': (
    <>
      ...
      <span className="text-base font-medium">- 졸업전시회 팀 인터랙티브아트 (p5.js ver.)</span>
      <div className="my-1" />
      <PartSubTitle title={'컨셉'} />
      <span className="font-semibold">"Bias"</span>
      <span className="pl-1">
        바구니를 선택하면 게임은 시작된다. 높은 점수를 얻기 위해 이리저리 움직이며 떨어지는 사탕들을 받아보자. 게임에 온전히 몰입하고 빠져들어보는 것이다.
      ...
      <ul>
        ...
        <li>2) 마우스 위치에 따라 바구니가 양옆으로 움직이며 하늘에서 떨어지는 사탕을 받으며 게임 진행 </li>
  ...
  treenow: (
    <>
      ...
      <span className="text-base font-medium">- B2B 조경 수목 거래 플랫폼 웹/하이브리드앱</span>
      <PartSubTitle title={'기술 스택'} />
      <span>- React.js, Typescript, Recoil, Tailwind, React-native(webview)</span>
      <PartSubTitle title={'팀구성'} />
  ...
  'nijoow-launchpad': (
    <>
      {' '}
      <PartTitle title={'View'} />
      <Work url="https://nijoow-launchpad.vercel.app/" imgSrc="nijoow-launchpad.png" />
      <div className="my-3" />
      <PartTitle title={'Explanation'} />
      ...
      <PartSubTitle title={'기능'} />
      <span>- 마우스/키보드/터치 이벤트로 런치패드를 클릭할 때 마다 사운드 재생</span>
      <span>- 피아노 사운드/드럼을 포함한 다양한 사운드의 두가지 모드로 연주 가능</span>
      <div className="my-3" />
      <PartTitle title={'Link'} />
      <Link
  ...
  memory: (
    <>
      ...
      <span>- 부산대학교 디자인학과 디자인엔테크놀로지 전공 12회 졸업전시회 웹사이트</span>
  ...
  portfolio: (
    <>
      ...
      <ul>
        ...
        <li>- Spotify API를 통해 AccessToken 발급 및 최근들은 음악 정보 소개</li>
  ...
  'ai-love-predictor': (
    <>
      <PartTitle title={'View'} />
      <Work url="https://ai-love-predictor.vercel.app/" imgSrc="ai-love-predictor.png"></Work>
      <div className="my-3" />
      <PartTitle title={'Explanation'} />
      <span className="text-xl font-bold">💓 너는 솔로? 그것이 알고싶다!</span>
      <span className="text-base font-medium">- 질문 응답을 통해 연애 확률 예측 결과를 보여주는 테스트</span>
      <span className="text-base font-medium">- 스터디용 사이드 프로젝트 (스터디가 종료되어 기획 미완성, 프론트엔드만 임시로 배포)</span>
      <span className="text-base font-medium">- 🚧 프론트엔드에 임시로 기능을 넣는 개발 진행 중 🚧</span>
      <PartSubTitle title={'기술 스택'} />
