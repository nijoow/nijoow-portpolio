...
export const WorkContent: WorkContents = {
  ...
  'catch-the-candy': (
    <>
      ...
      <span className="text-base font-medium text-gray-dark">- 졸업전시회 팀 인터랙티브아트 (p5.js ver.)</span>
      <div className="my-1" />
  ...
  treenow: (
    <>
      ...
      <span className="text-base font-medium text-gray-dark">- B2B 조경 수목 거래 플랫폼 웹/하이브리드앱</span>
      <PartSubTitle title={'기술 스택'} />
